		...
		<Page>
			<Section>
				...
				<div className='flex flex-col justify-center w-full py-20 leading-loose space-y-4'>
					...
					<h2 className='font-bold text-3xl'>Interpretation and Definitions</h2>
					...
					<ul>
						...
						<li>
							<p>
								...
								in this Agreement) refers to Pool Party.
							</p>
						</li>
						<li>
							<p>
					...
					<h2 className='font-bold text-3xl'>Changes to this Privacy Policy</h2>
					<p>
