		...
		<Page>
			<Section>
				...
				<div className='flex flex-col justify-center w-full py-20 leading-loose space-y-4'>
					...
					The pooling and distribution of cryptocurrency involve risks,
					including but not limited to market volatility, technical failures,
					and regulatory changes. Users participate at their own risk and are
					solely responsible for their contributions and any consequences.
					Distributions The website will make reasonable efforts to distribute
					the pooled funds according to the stated purpose and conditions of
					each escrow contract. However, the website does not guarantee the
					successful distribution or the performance of the escrow contracts.
					<h3 className='text-2xl font-bold'>Fees and Charges </h3>
					The website may charge fees for facilitating the pooling and
					distribution process. All applicable fees and charges will be
					disclosed transparently before any transaction. Intellectual Property
					...
					resolved in the courts of the United States of America. Modifications
