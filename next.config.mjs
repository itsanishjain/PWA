...
const cspHeader = `
    ...
    connect-src 'self' https://api.privy.io https://auth.privy.io wss://auth.privy.io https://mainnet.base.org https://explorer-api.walletconnect.com https://*.supabase.co https://*.stripe.com https://chain-proxy.wallet.coinbase.com;
