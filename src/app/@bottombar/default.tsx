    ...
    return (
        <AnimatePresence presenceAffectsLayout>
            <motion.footer
                ...
                <nav className='flex-center mx-auto h-24 max-w-screen-md rounded-t-3xl bg-neutral-100/50 shadow shadow-black/25 backdrop-blur-[32.10px] pb-safe px-safe-or-6'>
                    {content}
                </nav>
            </motion.footer>
        </AnimatePresence>
