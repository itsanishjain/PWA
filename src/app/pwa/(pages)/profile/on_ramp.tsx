...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    // const { chainName, jwtString } = await req.body
    // let jwtAddress: string | undefined = '0x'
    // let user
    // try {
    ...
    //         // nonce: crypto.randomBytes(16).toString('hex'), <--- this does nothing, better to remove it
    //     },
    // }
